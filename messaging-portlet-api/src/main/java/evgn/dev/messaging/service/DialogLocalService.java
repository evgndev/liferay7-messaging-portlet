...
/**
 * Provides the local service interface for Dialog. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DialogLocalServiceUtil
...
public interface DialogLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DialogLocalServiceUtil} to access the dialog local service. Add custom service methods to {@link evgn.dev.messaging.service.impl.DialogLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
